	...
	<div class="grid_5 omega">
		<div class="body-copy">
			<p>
				...
				With the mobile version of the Housing Guide you'll get quick access to all of our listings, complete with contact info, maps and links to driving directions, from whereever you are. The Housing Guide is designed to work on any internet capable mobile device. Just head over to <a href="http://www.dailylobo.com/index.php/m/housing">http://www.dailylobo.com/m/housing</a>.
			</p>
